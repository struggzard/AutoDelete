...
cp "$(go env GOPATH)/src/github.com/struggzard/AutoDelete/docs/build.sh" .
cp "$(go env GOPATH)/src/github.com/struggzard/AutoDelete/config.example.yml" config.yml
mkdir data
